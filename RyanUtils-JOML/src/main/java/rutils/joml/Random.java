...
public class Random extends rutils.Random
{
    ...
    {
        return vector.set(nextFloat(-1F, 1F), nextFloat(-1F, 1F)).normalize();
    }
    ...
    {
        return vector.set(nextFloat(-1F, 1F), nextFloat(-1F, 1F), nextFloat(-1F, 1F)).normalize();
    }
    ...
    {
        return vector.set(nextFloat(-1F, 1F), nextFloat(-1F, 1F), nextFloat(-1F, 1F), nextFloat(-1F, 1F)).normalize();
    }
    ...
    {
        return vector.set(nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0)).normalize();
    }
    ...
    {
        return vector.set(nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0)).normalize();
    }
    ...
    {
        return vector.set(nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0), nextDouble(-1.0, 1.0)).normalize();
    }
