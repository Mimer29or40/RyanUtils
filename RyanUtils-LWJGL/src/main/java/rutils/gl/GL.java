...
public enum GL
{
    ...
    {
        GL15C.nglBufferData(target.ref(), (long) data.remaining() * elementSize(data), memAddress(data), usage.ref());
    }
    ...
    {
        GL15C.nglBufferSubData(target.ref(), offset, (long) data.remaining() * elementSize(data), memAddress(data));
    }
    ...
    {
        GL15C.nglGetBufferSubData(target.ref(), offset, (long) data.remaining() * elementSize(data), memAddress(data));
    }
