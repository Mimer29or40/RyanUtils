...
public class Math
{
    ...
    {
        return (float) java.lang.Math.toDegrees(angrad);
    }
    ...
    {
        return (sign & Integer.MIN_VALUE) | (magnitude & Integer.MAX_VALUE);
    }
    
    /**
     * Returns the first long argument with the sign of the second long
     * argument.
     *
     * @param magnitude the parameter providing the magnitude of the result
     * @param sign      the parameter providing the sign of the result
    ...
    {
        return (sign & Long.MIN_VALUE) | (magnitude & Long.MAX_VALUE);
    }
    ...
    public static @NotNull IPairI getFormatNumbers(double... values)
    {
        ...
        {
            String[] num = Math.FORMAT_NUMBERS_SPLIT.split(Double.toString(val));
            numI = java.lang.Math.max(numI, num[0].length());
            if (val != (int) val) numD = java.lang.Math.max(numD, num[1].length());
        }
    ...
    public static @NotNull String format(double x, int numI, int numD)
    {
        ...
        String D = (numD > 0 ? String.valueOf((int) java.lang.Math.round(java.lang.Math.abs(getDecimal(x)) * java.lang.Math.pow(10, numD))) : "");
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (float) fma((b - a), x, a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (int) fma((b - a), smoothstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (long) fma((b - a), smoothstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (float) fma((b - a), smoothstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : fma((b - a), smoothstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (int) fma((b - a), smootherstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (long) fma((b - a), smootherstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : (float) fma((b - a), smootherstep(x), a);
    }
    ...
    {
        return x <= 0 ? a : x >= 1 ? b : fma((b - a), smootherstep(x), a);
    }
