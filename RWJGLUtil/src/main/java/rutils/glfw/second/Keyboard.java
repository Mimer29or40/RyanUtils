...
public class Keyboard
{
    ...
    public enum Key
    {
        ...
        Key(int reference, int baseChar, int shiftChar)
        {
            this.reference = reference;
            this.scancode  = glfwGetKeyScancode(reference);
        ...
        {
            return Key.KEY_MAP.getOrDefault(reference, Key.NONE);
        }
        ...
        static
        {
            for (Key key : values())
            {
                Key.KEY_MAP.put(key.reference, key);
            }
        }
    }
}
