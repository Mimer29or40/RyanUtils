        ...
        try
        {
            ...
            while (!this.close && this.open)
            {
                ...
                if (this.vsync != this._vsync)
                {
                    ...
                    GLFW.EVENT_BUS.post(EventWindowVsyncChanged.create(this, this.vsync));
                }
                
                if (this.focused != this._focused)
                {
                    this.focused = this._focused;
                    GLFW.EVENT_BUS.post(EventWindowFocused.create(this, this.focused));
                }
                
                if (this.iconified != this._iconified)
                {
                    this.iconified = this._iconified;
                    GLFW.EVENT_BUS.post(EventWindowIconified.create(this, this.iconified));
                }
                
                if (this.maximized != this._maximized)
                {
                    this.maximized = this._maximized;
                    GLFW.EVENT_BUS.post(EventWindowMaximized.create(this, this.maximized));
                }
                ...
                if (this.pos.x != this._pos.x || this.pos.y != this._pos.y)
                {
                    ...
                    GLFW.EVENT_BUS.post(EventWindowMoved.create(this, this.pos, this.deltaI));
                ...
                if (this.size.x != this._size.x || this.size.y != this._size.y)
                {
                    ...
                    GLFW.EVENT_BUS.post(EventWindowResized.create(this, this.size, this.deltaI));
                ...
                if (Double.compare(this.scale.x, this._scale.x) != 0 || Double.compare(this.scale.y, this._scale.y) != 0)
                {
                    ...
                    GLFW.EVENT_BUS.post(EventWindowContentScaleChanged.create(this, this.scale, this.deltaD));
                }
                ...
                if (this.fbSize.x != this._fbSize.x || this.fbSize.y != this._fbSize.y)
                {
                    ...
                    GLFW.EVENT_BUS.post(EventWindowFramebufferResized.create(this, this.fbSize, this.deltaI));
                ...
                {
                    this._refresh = false;
                    GLFW.EVENT_BUS.post(EventWindowRefreshed.create(this));
                }
                ...
                if (this._dropped != null)
                {
                    ...
                    this._dropped = null;
                    GLFW.EVENT_BUS.post(EventWindowDropped.create(this, paths));
                }
                ...
                if (updateMonitor)
                {
                    ...
                    {
                        GLFW.EVENT_BUS.post(EventWindowMonitorChanged.create(this, prevMonitor, this.monitor));
                    }
                }
